...
public class WeatherActivityTest {
    ...
    public void weatherActivityTest() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.forecast_item_date), withText("09 May 2017"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.forecast_text_layout),
                                        0),
                                0),
                        isDisplayed()));
        textView.check(matches(withText("09 May 2017")));
